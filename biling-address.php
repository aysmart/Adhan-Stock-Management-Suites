...
<head>
    ...
    <title>Billing Address || Flora Truworths Online Stores</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Billing Information</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<div class="login-form-area adminpro-pd mg-tb-15">
            <div class="container-fluid">
              ...
              <h4>Saved Billing Address</h4>
              <?php $query6=mysqli_query($con,"SELECT * FROM users WHERE UserID='".$_SESSION['id']."'"); 
        $row6=mysqli_fetch_array($query6);
        echo "<p><b> ".$row6['UserFirstName']." ".$row6['UserLastName'];                                    
        if($row6['UserAddress']!="" && $row6['UserAddress']!=" ")
        {?>

    <br><span><?php echo htmlentities($row6['UserAddress']) ?></span>
<?php if($row6['UserAddress2']!="" ){ echo '<br>'; echo htmlentities($row6['UserAddress2']);}?>
    <br><span><?php echo htmlentities($row6['UserCity'].",  ".$row6['UserState']); $_SESSION['Scity']=$row6['UserCity']; $_SESSION['Sstate']=$row6['UserState']; ?>
    <br><span><?php echo htmlentities($row6['UserPhone']) ?></b></p> 
    <?php } ?>
    <div class="modal-area-button">
    <a class="Warning Warning-color" style="background: #192958;" href="#" data-toggle="modal" data-target="#ChangeInformation">Change Billing Addresss</a>
        </div>         
  </div>
        </div>
        </div>
...
<?php } ?>
 ...
 $(document).ready(function(){  
      $('#process-change').click(function(){  
                    var baddress = document.getElementById('billingAddress').value;
                    var baddress2=document.getElementById('billingAddress2').value;
                    var bcity=document.getElementById('lgaSel').value;
                    var bstate=document.getElementById('StateSel').value;
                   // alert(baddress+"    "+baddress2+"    "+bcity+"     "+bstate);
        $.ajax({  
                url:"update-biling.php",  
                method:"post",
                data:{baddress:baddress, baddress2:baddress2, bcity:bcity, bstate:bstate},
