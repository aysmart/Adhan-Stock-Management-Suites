                        ...
                        <div class="sparkline8-list">
                            <div class="sparkline8-hd">
                                <div class="main-sparkline8-hd">
                                    <h1>Shipped Orders Information</h1>
                                </div>
                            </div>
<?php
$query=mysqli_query($con,"select * from orders WHERE OrderUserID='".$_SESSION['id']."' AND OrderStatus='Shipped'");
if ($query){
while($row=mysqli_fetch_array($query))
{
?>
                        <h5> Status:<span style="color:orange;">&nbsp;Processed And Shipped</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
