...
if(isset($_POST['ResetPass']))
{
  ...
  {
    $passw3= md5($passw1);
    $confirma=mysqli_query($con,"UPDATE users SET UserPassword='".$passw3."' WHERE UserVerificationCode='".$_GET['pid']."'");
    header('location:password-recovery-success'); 
  }
  else 
  {
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                <div class="text-center ps-recovered">
                    ...
                    <p>Please fill the form to recover your password</p><br>
                    ...
                    <div class="panel-body poss-recover">
                        ...
                        <form action="#" method="post" id="loginForm">
                            ...
                            <div class="text-center">
                                <button name="ResetPass" style="background: #192958;" class="btn btn-success loginbtn">Reset Password</button>
                            </div>
                        </form>
                    </div>
                </div>
